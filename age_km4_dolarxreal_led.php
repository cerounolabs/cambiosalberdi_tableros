...
<html>
	...
	<body>
		<table style="width:100%; height:100%; text-align:center;" border="1" cellpadding="1" cellspacing="1">
			<tr>
				<td style="width:100%; font-family:Arial Black; font-weight:bold; font-size:12px; color:#4caf50; background-color: #fff; letter-spacing: 0.10rem;" colspan="3">CAMBIOS ALBERDI S.A.</td>
			</tr>
<?php
	$nroRow = 0;
...
?>
			<tr>
				<td class="<?php echo $titulo; ?>"><?php echo $tableroVALUE['moneda']; ?></td>
				<td class="<?php echo $estilo; ?>"><?php echo $tableroVALUE['compra']; ?></td>
				<td class="<?php echo $estilo; ?>"><?php echo $tableroVALUE['venta']; ?></td>
			</tr>
<?php
		$nroRow = $nroRow + 1;
	}
