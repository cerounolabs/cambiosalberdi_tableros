...
<html>
	<head>
		...
		<title>Tablero - Sucursal Villa Morra</title>
		<style>
			html{
		...
		<script>
			//function muestraReloj() {
				...
				var mt 				= "AM";
				var anScreen		= document.body.clientWidth;
				var alScreen		= document.body.clientHeight;
	...
	<body onLoad="muestraReloj()">
		<table style="width:100%; height:100%;" border="1" cellpadding="0" cellspacing="2">
			...
			<tr style="width:100%; text-align:center; font-family:Arial Black; font-size:50px; font-weight:bold; background-color:#ffffff; color:black;" border="1" cellpadding="1" cellspacing="2">
			...
			while ($R = ibase_fetch_object($Q)) {
				...
				if (($R->ID_MONEDA) == 3 OR ($R->ID_MONEDA) == 4 OR ($R->ID_MONEDA) == 5 OR ($R->ID_MONEDA) == 6) {
					if (($R->TCCCOMPRABB != 0) OR ($R->TCVENTABB != 0)) {
						echo '<tr style="font-family:Arial Black; font-weight:bold; color:white; background-color:#0B6138; font-size:50px;">';
