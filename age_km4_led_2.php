...
<html>
	...
	<body>
		<table style="width:100%; height:100%; text-align:center; border:1px solid grey;" border="1" cellpadding="0" cellspacing="0">
			<!--
			<tr>
				<td style="width:100%; font-family:Arial Black; font-weight:bold; font-size:12px; color:#4caf50; background-color: #000; letter-spacing: 0.10rem;" colspan="3">CAMBIOS ALBERDI S.A.</td>
			</tr>
			-->
<?php
	$nroRow = 0;
	
	foreach ($JSONTablero02 as $tableroKEY => $tableroVALUE) {
		if ($nroRow%2 == 0){
			$titulo	= 'tituloOLD';
			$estilo = 'estiloOLD';
		}else{
...
?>
			<tr style="border:1px solid grey;">
				<td class="<?php echo $titulo; ?>" style="border:1px solid grey;"><?php echo $tableroVALUE['moneda']; ?></td>
				<td class="<?php echo $estilo; ?>" style="border:1px solid grey;"><?php echo $tableroVALUE['compra']; ?></td>
				<td class="<?php echo $estilo; ?>" style="border:1px solid grey;"><?php echo $tableroVALUE['venta']; ?></td>
			</tr>
<?php
		$nroRow = $nroRow + 1;
	}
