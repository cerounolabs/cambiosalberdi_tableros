...
<html>
	<head>
		...
		<title>Tablero - Sucursal Matriz</title>
		<style>
			html{
				width: 100%;
				height: 100%;
		...
		<script>
			function muestraReloj() {
				...
				cadenareloj = "<font size='6.5' face='verdana'><b>" + horas + ":" + minutos + ":" + segundos + " " + mt + "</b></font>";
	...
	<body onLoad="muestraReloj()">
		<table style="width:100%; height:100%;" border="1" cellpadding="0" cellspacing="2">
			...
			<tr style="width:100%; text-align:center; font-family:Arial Black; font-size:60px; font-weight:bold; background-color:#ffffff; color:black;" border="1" cellpadding="1" cellspacing="2">
		...
		<?php
			...
			while ($R = ibase_fetch_object($Q)) {
				...
				if (($R->ID_MONEDA) == 3 OR ($R->ID_MONEDA) == 4 OR ($R->ID_MONEDA) == 6) {
					if (($R->TCCCOMPRABB != 0) OR ($R->TCVENTABB != 0)) {
						echo '<tr style="font-family:Arial Black; font-weight:bold; color:white; background-color:#0B6138; font-size:60px;">';
			...
			echo "</tr>";
		?>
			<tr style="font-weight:bold; font-size:32px !important; color:black; background-color:#ffffff;">
